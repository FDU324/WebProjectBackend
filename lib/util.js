...
function returnComments(momentID, username) {
    ...
    return Comment.findAll({
        ...
        let temComments = comments.filter(comment => {
            ...
            return Friend.findAll({
                where: {
                    $or: [
                        {
                            first: username,
                            $or: [{second: commentUsername}, {second: commentToUsername}]
                        },
                        {
                            first: [{second: commentUsername}, {second: commentToUsername}],
                            second: username
                        }
                    ]
                }
